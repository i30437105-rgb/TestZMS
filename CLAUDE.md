...
- **Кнопка «Записаться на аудит»** (CareerSection) → нужна ссылка на страницу аудита (заказчик предоставит URL)
- **Кнопка «Забрать бонусы»** (LandingStepsSection) → сейчас отправляет форму в Telegram. После отправки нужно выдать ссылки на бонусные материалы (заказчик предоставит ссылки)
- **Статус**: ждём ссылки от заказчика
...
1. Ссылки в кнопках (ждём URL от заказчика)
2. Яндекс.Метрика + цели (нужно ДО запуска рекламы)
3. UTM-метки (нужно ДО запуска рекламы)
4. Домен (желательно до рекламы, чтобы ссылка была красивой)
