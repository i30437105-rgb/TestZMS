...
- **Кнопка «Забрать бонусы»** → форма отправляет в Telegram + открывает `t.me/metodzms_bot` (placeholder, нужна реальная ссылка бота)
- **Статус**: частично выполнено (аудит готов, бонусы — нужна реальная ссылка бота)
...
1. ~~Ссылки в кнопках~~ — аудит готов, бонусы частично (нужна ссылка бота)
